...
$(function () {
    ...
    if (errorinfo.val() == null || errorinfo.val() == "") {
        $("#spanTips").html("*上传文件大小不得超过500K * 上传文件格式为:jpg、jpeg、png、pneg");
    } else {
        $("#spanTips").html(errorinfo.val());
    }

    if (errorinfo_wp.val() == null || errorinfo_wp.val() == "") {
        $("#spanTips_wp").html("*上传文件大小不得超过500K * 上传文件格式为:jpg、jpeg、png、pneg");
    } else {
        $("#spanTips_wp").html(errorinfo_wp.val());
    }
    ...
    /*userCode.bind("blur",function(){
        ...
        $.ajax({
            ...
            data:{userCode:userCode.val()},//请求参数,json格式
