...
<header class="publicHeader">
    ...
    <div class="publicHeaderR">
        <p><span>下午好！</span><span style="color: #fff21b"> ${userSession.userName },${userSession.userRole}</span> , 欢迎你！
        </p>
    ...
    <div class="left">
        ...
        <nav>
            <ul class="list">
                ...
                <li><a href="${pageContext.request.contextPath }/sys/user/updatepwd.html?id=${userSession.id}">密码修改</a>
                </li>
