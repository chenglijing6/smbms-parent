...
<div class="right">
    ...
    <div class="search">
        <form method="post" action="${pageContext.request.contextPath}/sys/provider/providerlist.html">
            ...
            <c:if test="${userSession.userRole !=3}">
                <a href="${pageContext.request.contextPath}/sys/provider/addProvider.html">添加供应商</a>
            </c:if>
        </form>
    </div>
    <!--用户-->
    <table class="providerTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="provider" items="${providerList }" varStatus="status">
            <tr>
                ...
                <td>
                    <span><a class="viewProvider0" href="javascript:;" id=${provider.id}><img
                    ...
                    <c:if test="${userSession.userRole == 1 or userSession.userRole==2}">
                        <span><a class="modifyProvider0" href="javascript:;" id=${provider.id}><img
                                src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改"
                                title="修改"/></a></span>
                        <span><a class="deleteProvider0" href="javascript:;"
                                 providerid=${provider.id} proName=${provider.proName }><img
    ...
    <div class="providerAdd" id="providerView" style="display: none">
        <div>
            <label>供应商编码：</label>
