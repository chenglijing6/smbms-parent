...
<div class="right">
    ...
    <div class="search">
        <form method="post" action="${pageContext.request.contextPath}/sys/bill/billlist.html">
            ...
            <select name="isPayment">
                <option value="">--请选择--</option>
                <option value="" <c:if test="${isPayment==1}">selected="selected"</c:if>>已付款</option>
                <option value="" <c:if test="${isPayment==2}">selected="selected"</c:if>>未付款</option>
            </select>
        ...
        <div class="col-md-6">
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    ...
                    <li><a href="${pageContext.request.contextPath}/sys/bill/billlist.html?pageIndex=1">首页</a></li>

                    <!--上一页-->
                    <li>
                        <c:if test="${page.hasPreviousPage}">
                            <a href="${pageContext.request.contextPath}/sys/bill/billlist.html?pageIndex=${page.pageNum-1}" aria-label="Previous">
                    ...
                    <c:forEach items="${page.navigatepageNums}" var="page_num">
                        ...
                        <c:if test="${page_num != page.pageNum}">
                            <li><a href="${pageContext.request.contextPath}/sys/bill/billlist.html?pageIndex=${page_num}">${page_num}</a></li>
                        </c:if>
                    </c:forEach>
                    ...
                    <li>
                        <c:if test="${page.hasNextPage}">
                            <a href="${pageContext.request.contextPath}/sys/bill/billlist.html?pageIndex=${page.pageNum+1}"
                               aria-label="Next">
                                <span aria-hidden="true">»</span>
                            </a>
                        </c:if>
                    ...
                    <li><a href="${pageContext.request.contextPath}/sys/bill/billlist.html?pageIndex=${page.pages}">尾页</a></li>
                </ul>
            </nav>
        </div>
    ...
    <%--<input type="hidden" id="totalPageCount" value="${totalPageCountz}"/>
